...
| [`fluxions-realtime`](fluxions-realtime/) | Fluxions realtime voice API — server-side ASR, routing, TTS and barge-in over one WebSocket, with locally executed tools |
...
| [`huggingface`](huggingface/) | The huggingface/speech-to-speech cascade on HF dedicated Inference Endpoints — Whisper turbo, DeepSeek V4 Flash on vLLM, Kokoro TTS (serverless Inference Providers fallback included) |
