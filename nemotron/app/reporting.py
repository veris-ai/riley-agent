...
it lands in the graded trace. Pipecat tools execute in-process on the pipeline
and never reach the actor transcript, so without this the grader can't
...
logger = logging.getLogger("riley-nemotron")
