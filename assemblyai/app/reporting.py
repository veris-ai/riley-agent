...
it lands in the graded trace. Voice Agent tools execute in-process in this
bridge and never reach the actor transcript, so without this the grader can't
...
logger = logging.getLogger("riley-assemblyai")
