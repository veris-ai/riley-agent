...
it lands in the graded trace. LiveKit tools execute in-process on the Agents
worker and never reach the actor transcript, so without this the grader can't
